...
var query5 = _.filter(bakedGoods, function(theO){return theO.price > 4 ;});
...
var query6 = _.sortBy(bakedGoods, function(theO){return theO.inventory;});
...
var query7 = _.groupBy(bakedGoods, function(theO){return theO.type;});
...
var printMenu = function(foodList) {
  var types = Object.keys(foodList);
  _.each(types, function(theType){
    console.log(theType);
    _.each(foodList[theType], function(food) {
      console.log(food.name + ' ... $' + food.price);
    });
  });
};
